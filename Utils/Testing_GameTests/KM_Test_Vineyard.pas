...
type
  TKMRunnerVineyard_Harvest = class(TKMTest)
  protected
...
function TKMRunnerVineyard_Harvest.DoTick(aTick: Cardinal): Boolean;
var
  H: TKMHouse;
begin
  Result := True;
...
class function TKMRunnerVineyard_Harvest.TestTags: TKMTestTagSet;
begin
  Result := [tcVineyard, tcEconomy];
end;

class function TKMRunnerVineyard_Harvest.TestDescription: string;
begin
