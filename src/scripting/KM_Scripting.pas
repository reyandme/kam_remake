...
begin
  ...
  begin
    ...
    Sender.AddTypeS('TStringArray', 'array of AnsiString'); //Needed for some array Utils
    ...
    RegisterMethodCheck(c, 'function ArrayRemoveIndexS(aIndex: Integer; aArray: TStringArray): TStringArray');
