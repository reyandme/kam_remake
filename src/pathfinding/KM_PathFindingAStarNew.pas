      ...
      begin
        ...
        begin
          ...
          begin
            ...
            //todo -cPractical: Cost has changed and the location in the queue needs to change too
            //fHeap.UpdateItem(N);
          end;
        end;
      end;
...
begin
  ...
  //Cache long paths
  if FEAT_CACHE_PATHFINDING and (NodeList.Count > PATH_CACHE_NODES_MIN_CNT) then
    AddToCache(NodeList);
end;
