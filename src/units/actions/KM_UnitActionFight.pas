...
begin
  ...
  makeBattleCry := KaMRandom(20{$IFDEF DBG_RNG_SPY}, 'TKMUnitActionFight.MakeSound'{$ENDIF}) = 0;
...
begin
  ...
  begin
    ...
    isHit := (damage >= KaMRandom(101{$IFDEF DBG_RNG_SPY}, 'TKMUnitActionFight.ExecuteProcessMelee'{$ENDIF})); //Damage is a % chance to hit
    if isHit then
