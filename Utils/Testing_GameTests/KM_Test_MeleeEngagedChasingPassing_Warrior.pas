unit KM_Test_MeleeEngagedChasingPassing_Warrior;
{$I KaM_Remake.inc}
interface
uses
  KM_Test,
...
type
  TKMTest_MeleeEngagedChasingPassing_Warrior = class(TKMTest)
  private
    fPassingUnit: TKMUnitWarrior;
  protected
...
procedure TKMTest_MeleeEngagedChasingPassing_Warrior.SetUp;
begin
  inherited;
  ...
  fPassingUnit := gHands[1].UnitGroups[0].Members[0];

  gHands[1].AddUnitGroup(utMilitia, TKMPoint.New(10, 17), dirN, 3, 3);
end;


procedure TKMTest_MeleeEngagedChasingPassing_Warrior.TearDown;
begin
  inherited;
...
procedure TKMTest_MeleeEngagedChasingPassing_Warrior.DoTick(aTick: Cardinal; var aKeepGoing: Boolean);
begin
  if aTick = 1 then
...
class function TKMTest_MeleeEngagedChasingPassing_Warrior.TestTags: TKMTestTagSet;
begin
  Result := [tcCombat];
end;


class function TKMTest_MeleeEngagedChasingPassing_Warrior.TestDescription: string;
begin
...
initialization
  RegisterTest(TKMTest_MeleeEngagedChasingPassing_Warrior);
end.
