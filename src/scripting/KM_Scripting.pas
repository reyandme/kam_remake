...
begin
  ...
  begin
    ...
    RegisterMethodCheck(c, 'procedure MapCopyRect(aFromTileX: Integer; aFromTileY: Integer; aWidth: Integer; aHeight: Integer; ' +
      'aToTileX: Integer; aToTileY: Integer)');
    ...
    RegisterMethodCheck(c, 'function  MapTilesArraySetF(aFileName: string; aOffsetX: Integer; aOffsetY: Integer; aRevertOnFail: Boolean; ' +
      'aShowDetailedErrors: Boolean): Boolean');
...
begin
  ...
  try
    ...
    begin
      ...
      RegisterMethod(@TKMScriptActions.MapCopyRect, 'MapCopyRect');
