...
procedure TKMTest_Bakery.DoTick(aTick: Cardinal; var aKeepGoing: Boolean);
begin
  // Keep running until bread is produced
  aKeepGoing := gHands[0].Stats.GetWaresProduced(wtBread) = 0;
end;


procedure TKMTest_Bakery.CheckResult;
begin
