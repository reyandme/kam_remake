...
begin
  ...
  // DEBUG. no need to check on every tick in release version, but for test releases we should remove the "each 10 ticks" clause
  if gNetworking.Connected and (aTick mod 10 = 1) then
