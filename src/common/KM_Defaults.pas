...
var
  ...
  DBG_AGGRESSIVE_REPLAYS            :Boolean = False; //Write a command gicTempDoNothing every tick in order to find exactly when a replay mismatch occurs
  ...
  DBG_SKIP_TERRAIN_RENDER_ANIMS     :Boolean = False; //Skip render terrain animations
  DBG_SKIP_TERRAIN_RENDER_LIGHT     :Boolean = False; //Skip render terrain lighting
  DBG_SKIP_TERRAIN_RENDER_SHADOW    :Boolean = False; //Skip render terrain shadows
