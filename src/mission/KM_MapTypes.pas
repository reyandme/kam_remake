...
type
  TKMMapKind = (mkUnknown, mkSP, mkMP, mkCM, mkDL);
...
const
  ...
  MAP_FOLDER_NAME: array [TKMMapKind] of string = ('', MAPS_FOLDER_NAME, MAPS_MP_FOLDER_NAME, CAMPAIGNS_FOLDER_NAME, MAPS_DL_FOLDER_NAME);
